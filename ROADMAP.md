...
- No se puede renombrar los 5 metodos de NoteService ni cambiarle parámetros o tipo de retorno, tampoco las rutas HTTP, los campos de Note, ni la función notify.
- El nombre de cada archivo de test debe quedar fijo (el corrector automático los busca por nombre exacto).
...
| Integrante | Tareas |
|------------|--------|
| [@fedeheinrich](https://github.com/fedeheinrich) | Setup del repo (npm install, correr npm run dev y npm test para confirmar que arranca) + Ejercicio 1 (createNote) + Ejercicio 2 (test de listNotes). Es lo primero que tiene que estar en verde y pusheado. |
| [@nicc-essp](https://github.com/nicc-essp) | Ejercicio 3 completo: test unitario de getNote (caso feliz + id inexistente) + implementación + test de integración de GET /notes/:id |
| [@HomeroColomboArg](https://github.com/HomeroColomboArg) | Ejercicio 4 completo: test unitario de updateNote (patch parcial: solo title, solo content, id inexistente) + implementación + test de integración de PATCH /notes/:id |
| [@Oviedo-Matias](https://github.com/Oviedo-Matias) | Ejercicio 5 completo: test unitario de deleteNote + implementación + test de integración de DELETE /notes/:id |


### Una vez que los ejercicios del 1 al 5 estén mergeados a main:
| Integrante | Tareas |
|------------|--------|
| [@fedeheinrich](https://github.com/fedeheinrich) | sigue con el Ejercicio 6 (notificación al fijar), porque ya conoce createNote de punta a punta.|
|[@Oviedo-Matias](https://github.com/Oviedo-Matias) | (delete suele ser el más rápido de los tres) arma el Ejercicio 7 (E2E), que necesita todo lo anterior resuelto para que el seed funcione.|
| [@nicc-essp](https://github.com/nicc-essp) y [@HomeroColomboArg](https://github.com/HomeroColomboArg) | revisan el E2E antes de entregar.|
